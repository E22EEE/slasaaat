...
msg.TheRank = redis:get(MOD..":RtbaNew1:"..msg.chat_id_) or 'مطور اساسي ' 
msg.Rank = 1
...
msg.TheRank = redis:get(MOD..":RtbaNew6:"..msg.chat_id_) or 'مدير البوت ' 
msg.Rank = 6
...
answerCallbackQuery(data.id_," بنجاح والتأكد بانك لست روبوت ",true)
EditMsg(ChatID,dataid," والتأكد بانك لست روبوت ")
else
...
if (msg.text=="تحديث" or msg.text=="we" or msg.text=="تحديث ") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 819385837 or msg.sender_user_id_ == 60809019) then
