...
return sendMsg(msg.chat_id_,msg.id_,"المالك :\n["..v.user.first_name.."](t.me/"..(v.user.username or "E22EE2"))
end
end
...
if not redis:get(MOD..'linkGroup'..msg.chat_id_) then return "*⌯* اوه لا يوجد رابط \n*⌯*لانشاء رابط ارسل { انشاء رابط } \n" end
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[⌯ اهلااً بك ؏ـزيزي . \n⌯ انا بوت اسمي ]]..redis:get(MOD..':NameBot:')..[[⌯ آختصـآصي حمايۿ الكروبات . \n⌯ من السبام والتكرار والتوجيه . \n⌯ لتفعيلي اتبع الخطوات ↓ .\n⌯ اضفني الى مجموعتك . \n⌯ ارفعني ادمن ~ مشرف . \n⌯ ارسل كلمة ~ تفعيل . \n⌯ سيتم ترقيتك منشئ آساسي تلقائياً . \n⌯ مطور البوت [ 𝗠𝘂𝘀𝗧𝗮𝗙𝗮 ](https://t.me/e22eee) . \n 
]]
) 
return false
else
...
local inline = {{{text="قنآهہ‏‏ آلسـورس : MarooNed",url="t.me/E22EE2"}}}
send_key(msg.sender_user_id_,'  [قناة السورس :  MarooNed](t.me/E22EE2)',nil,inline,msg.id_)
return false
end
...
text = [[⌯ اهلااً بك ؏ـزيزي . \n⌯ انا بوت اسمي []]..redis:get(MOD..':NameBot:')..[[] \n⌯ آختصـآصي حمايۿ الكروبات . \n⌯ من السبام والتكرار والتوجيه . \n⌯ لتفعيلي اتبع الخطوات ↓ .\n⌯ اضفني الى مجموعتك . \n⌯ ارفعني ادمن ~ مشرف . \n⌯ ارسل كلمة ~ تفعيل . \n⌯ سيتم ترقيتك منشئ آساسي تلقائياً . \n⌯ مطور البوت [ 𝗠𝘂𝘀𝗧𝗮𝗙𝗮 ](https://t.me/e22eee) . \n]]
GetUserID(msg.sender_user_id_,function(arg,data)
if data.last_name_ then Name = data.first_name_ .." "..data.last_name_ else Name = data.first_name_ end
...
return sendMsg(msg.chat_id_,msg.id_,"⌯ عذرآ لآ يمـگنگ آرسـآل {ملف , توجيه‌‏ , مـلصـق , فديو گآم} ")
end
SUDO_USER = redis:hgetall(MOD..'username:'..SUDO_ID).username
if SUDO_USER:match('@[%a%d_]+') then 
SUDO_USERR = "\n "..SUDO_USER
...
"ايامي وياها👫اتمنا انساها😔متندم اني حيل😞يم غيري هيه💃تضحكعليه😔مقهور انام الليل😢كاعد امسح بل رسائل✉️وجان اشوف كل رسايلها📩وبجيت هوايه😭شفت احبك😍واني من دونك اموت😱وشفت واحد صار هسه وياية👬اني رايدها عمر عمر تعرفني كل زين🙈 وماردت لا مصلحة ولاغايه😕والله مافد يوم بايسها💋خاف تطلع البوسه💋وتجيها حجايه😔️",
"😔صوتي بعد مت سمعه✋يال رايح بلا رجعةبزودك نزلت الدمعة ذاك اليوم☝️يال حبيتلك ثاني✌روح وياه وضل عاني😞يوم اسود علية اني🌚 ذاك اليوم☝️تباها بروحك واضحلان بجيتلي عيني😢😭 وافراح يابعد روحي😌خل الحركة تجويني😔🔥صوتي بعد متسمعة ✋",
}
...
⌯ لتتندم فڪر قبل ڪلشي  
⌯ بالتـوفيـق عزيزي .. ⌯ـ  https://telegram.org/deactivate
]] )
--=====================================
