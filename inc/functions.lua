...
var = redis:get(MOD..":RtbaNew1:"..ChatID) or 'مطور اساسي ' 
...
var = redis:get(MOD..":RtbaNew6:"..ChatID) or 'مدير البوت ' 
...
local eueuf = "\n\n**` اعدادات اخرى : `"
.."\n** الترحيب » "..(redis:get(MOD..'welcome:get'..msg.chat_id_) or 'false')
